...
#player = mouse.position()  #start at the click
...
#Create a orange rectangle that represent the agent. it size is 0.2 less than the other rectangle in all side
